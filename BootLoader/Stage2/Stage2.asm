...
;	Data Section
;*******************************************************
StartingMsg db 0x0D, 0x0A, "Starting stage 2", 0x00
LoadingMsg db 0x0D, 0x0A, "Searching for Operating System...", 0x00
LoadingOSMsg db 0x0D, 0x0A, "Loading Operating System...", 0x00
msgFailure db 0x0D, 0x0A, "Missing or corrupt KRNL32.EXE.", 0x0D, 0x0A, 0x0A, 0x00
msgFailure2 db 0x0D, 0x0A, "Missing or corrupt KERNAL.BIN.", 0x0D, 0x0A, 0x0A, 0x00
msgContinue db 0x0D, 0x0A, "Press Any Key to Continue" , 0x0D, 0x0A, 0x0A, 0x00
msgFailureini db 0x0D, 0x0A, "boot.ini missing" , 0x0D, 0x0A, 0x0A, 0x00
LoadingExeMode db 0x00
...
main:
	...
	;-------------------------------;
	;  Attempt Loading other os     ;
	;-------------------------------;
	mov byte [LoadingExeMode],1
...
BINImage db "Loading BIN File", 0
Stage3:
...
LoadBINFile:
  	  mov	ebx, BINImage
  	  call	Puts32
	  ;Copying image____________________________
